...
import img1 from "../images/s1 3.png"
import vector20 from "../images/Vector 20.png"
import kyc from "../images/s2 (1).png"
import mobile2 from "../images/s1 10.png"
import mobile3 from "../images/s3 (1).png"
import img2 from "../images/s2.png"
import img4 from "../images/s3.png"
import mv1 from "../images/Vector 72.png"
import img44 from "../images/s4 (1).png"
import img167 from "../images/s5 (2).png"
import img5 from "../images/s5 (1).png"
import img6 from "../images/s4.png"
...
export default function TruckerReroute() {
    return (
        <div>
                    ...
                    <Grid container spacing={2} sx={{ '@media (max-width: 700px)': { flexDirection: 'column', justifyContent: "flex-end" } }}>
                        <Grid item lg={4} md={4} sm={4}>
                            ...
                            <Box sx={makeStyle.mediaInfo}>
                                <Typography sx={makeStyle.info}>Verify the KYC and other details like Aadhaar, PAN and Vehicle Registration.</Typography>
                            </Box>
                        ...
                        <Grid item lg={4} md={4} sm={4}>
                            ...
                            <Box sx={makeStyle.mediaInfo}>
                                <Typography sx={makeStyle.info}>Show interest based on availability
                                    of truck</Typography>
                            </Box>
                        ...
                        <Grid item lg={4} md={4} sm={4}>
                            <Box sx={{ position: "relative" }}>
                                ...
                                <Box sx={makeStyle.mediaInfo}>
                                    <Typography sx={makeStyle.info} >Once the load is confirmed, receive advance payment and start the trip.</Typography>
                                </Box>
                                <Box sx={makeStyle.orderBox} display="flex" justifyContent="center" alignItems="center">
                                    <Box>
            ...
            <Box sx={makeStyle.bottomRoute}>
                ...
                <Box sx={makeStyle.item1}>
                    ...
                    <Typography sx={makeStyle.info4}>Find more loads to maximize your profits with ReeRoute.</Typography>
                    <Typography sx={makeStyle.orderBottom}>5</Typography>

                </Box>
                <Box sx={makeStyle.item2}>
                    <img src={img6} alt="" style={{ maxWidth: "80%", height: "165px" }} />
                    <Typography sx={makeStyle.info4}>Upon trip completion, upload POD and receive balance amount on original POD submission.</Typography>
